...
async def test_workaround_ge_12730_fan(hass, fan_ge12730_data):
    """Test GE 12730 fan workaround."""
    await setup_ozw(hass, fixture=fan_ge12730_data)
...
async def test_workaround_leviton_vfr01_1lz_fan(hass, fan_leviton_vfr01_1lz_data):
    """Test Leviton VRF01-1LZ fan workaround."""
...
async def test_workaround_inovelli_lzw36_fan(hass, fan_lzw36_data):
    """Test Inovelli LZW36 fan workaround."""
